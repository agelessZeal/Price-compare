...
Route::get('view_more/category', [
    'as' => 'view.more.category',
    'uses' => 'DashboardController@viewMoreCategory'
]);
...
Route::get('product/view',[
    'as' => 'product.view.detail',
    'uses' => 'ProductController@viewDetail'
]);
//---------------------------------------------------------------
...
Route::put('product/{product}/update/detail',[
    'as' => 'product.update.detail',
...
Route::post('product/upload/image',[
    'as' => 'product.upload.image',
    'uses' => 'ProductController@uploadImage'
]);

Route::post('product/active/bulk',[
    'as'=>'product.active.bulk',
    'uses'=> 'ProductController@activeBulkProduct'
]);

Route::post('product/delete/bulk',[
    'as'=>'product.delete.bulk',
    'uses'=> 'ProductController@deleteBulkProduct'
]);

Route::post('product/store/related',[
   'as'=>'product.store.related',
   'uses'=>'ProductController@storeRelatedProducts'
]);
...
Route::get('favorite/profile', [
    'as' => 'favorite.profile',
    'uses' => 'FavoriteController@profile'
]);
...
// Only allow managing 2FA if AUTHY_KEY is defined inside .env file
    ...
    Route::post('favorite/add/product',[
       'as' => 'favorite.add.product',
       'uses' => 'FavoriteController@addToFavorite'
    ]);

    Route::post('favorite/delete/product',[
        'as' => 'favorite.delete.product',
        'uses' => 'FavoriteController@deleteProfileProduct'
    ]);
...
//---------------------------------------------------------------
    Route::get('category/view',[
        'as' => 'category.view.detail',
        'uses' => 'CategoryController@viewDetail'
    ]);
//---------------------------------------------------------------
    ...
    Route::put('category/{category}/update/detail',[
        'as' => 'category.update.detail',
        'uses' => 'CategoryController@updateDetail'
    ]);
